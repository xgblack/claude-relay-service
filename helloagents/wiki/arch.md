...
- 并行增强：管理端新增 `/admin/plus` 前缀的并行路由，承载调用明细与调度增强，避免影响主干路径
...
|--------|-------|------|--------|------------------|---------|
| ADR-001 | 并行增强路线替代内联修改 | 2025-12-06 | ✅已采纳 | admin 路由、调度器、前端仪表盘 | plan/202512062347_dev-sync-enhance/how.md#架构决策-adr |
